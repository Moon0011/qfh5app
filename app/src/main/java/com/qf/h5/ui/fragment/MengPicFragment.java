...
import com.qf.h5.R;
import com.qf.h5.adapter.MengPicAdapter;
...
public class MengPicFragment extends BaseFragment {
    @Bind(R.id.recycler_view)
    RecyclerView recyclerView;
    private MengPicAdapter mengPicAdapter;
    ...
    protected void initData() {
        ...
        mengPicAdapter = new MengPicAdapter(getActivity(), recomList);
        recyclerView.setAdapter(mengPicAdapter);
    }
}
